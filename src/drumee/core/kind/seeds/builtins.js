...
const a = {
  ...
  document_reader:function(s,f){import('builtins/player/document/index.electron').then(m=>{s(m.default)}).catch(f)},
  ...
  widget_chat_item:function(s,f){import('builtins/widget/chat-item').then(m=>{s(m.default)}).catch(f)},
  ...
  window_changelog:function(s,f){import('src/drumee/builtins/window/changelog').then(m=>{s(m.default)}).catch(f)},
  changelog_event:function(s,f){import('src/drumee/builtins/window/changelog/widget/event').then(m=>{s(m.default)}).catch(f)},
  ...
  welcome_signin:function(s,f){import('modules/welcome/signin').then(m=>{s(m.default)}).catch(f)},
  welcome_signup:function(s,f){import('welcome/signup').then(m=>{s(m.default)}).catch(f)},
  welcome_signin_history:function(s,f){import('modules/welcome/signin/history').then(m=>{s(m.default)}).catch(f)},
