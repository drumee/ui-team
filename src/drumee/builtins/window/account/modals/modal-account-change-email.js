...
const __modal_account_change_email = function(manager) {
  ...
  const a = { 
    ...
    kids: [
      ...
      SKL_Note(null, "Change account mail", {
...
module.exports = __modal_account_change_email;
