...
const a = {
  ...
  wrapper             : {
    ...
    button_icon       : '#--wrapper-icon-button',
    canvas            : '#--wrapper-canvas',
    content           : '#--wrapper-content',
    designer          : '#--wrapper-designer',
    designer_note     : "#--wrapper--designer-note",
    fselector         : '#--wrapper-fselector',
    slide             : '#--wrapper-slide',
    div               : '#--wrapper-div',
    img_button        : '#--wrapper-img-button',
    id                : '#--wrapper-id',
    image             : '#--wrapper-image',
    input             : '#--wrapper-input',
    input_label       : '#--wrapper-input-label',
    input_raw         : '#--wrapper-input-raw',
    note              : '#--wrapper-note',
    picto             : '#--wrapper-picto',
    raw               : '#--wrapper-raw',
    ...
    site              : '#--wrapper-site',
    svg               : '#--wrapper-svg',
    svg_label         : '#--wrapper-svg-label',
    svg_raw           : '#--wrapper-svg-raw',
    ul                : '#--wrapper-ul'
  },
//  editable             :
