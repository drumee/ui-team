module.exports = function (type) {
  const widgetId = _.uniqueId();
  const svg = `
    <svg class="folder-shape ${type}" width="105" height="86" viewBox="0 0 105 86" fill="none" xmlns="http://www.w3.org/2000/svg">
