...
| `widget-development.md` | `builtins/{widget,panel,editor,messenger,media,permission}/**`, `builtins/window/**/widget/**`, `api/lib/**` | widget lifecycle, base class (+ exceptions), WS bind/unbind cleanup |
