...
class __desk_user_contributor extends LetcBox {
  constructor(...args) {
...
// ===========================================================
  _url() {
    const id   = this.model.get(_a.id); 
    const url = `${bootstrap().mfsRootUrl}avatar/${id}?${timestamp()}`;
    return url;
  }
}
__desk_user_contributor.initClass(); 





module.exports = __desk_user_contributor;
