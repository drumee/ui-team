...
module.exports = {
  ...
  window_manager:function(s,f){import('desk/wm/index.electron').then(m=>{s(m.default)}).catch(f)},
  ...
  butler:function(s,f){import('src/drumee/router/butler/index.electron').then(m=>{s(m.default)}).catch(f)},
