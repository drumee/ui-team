...
//
// ===========================================================
const __skl_unpublish_buttons = function(view, yes_ext, no_ext, ext, style) {
  ...
  const buttons = [
    ...
    SKL_Note(null, "Unpublish", yes_opt) //_L(_I.GOT_IT
  ];
  const row_opt     = {className:"popup__btn-block u-jc-sb", kids:buttons, justify:_a.center};
...
module.exports = __skl_unpublish_buttons;
