    ...
    kids: [
      Skeletons.Box.X({
        ...
        kids: [
          Skeletons.Box.Y({
            ...
            kids: [
              Skeletons.Note({ className: `${pfx}__versioning-title`, content: LOCALE.FILE_VERSIONING }),
              Skeletons.Note({ className: `${pfx}__versioning-desc`,  content: LOCALE.FILE_VERSIONING_DESC }),
            ],
          }),
          Skeletons.Box.X({
      ...
      Skeletons.Box.X({
        ...
        kids: [
          ...
          Skeletons.Note({ className: `${pfx}__fcol file`,      content: LOCALE.FILE      }),
          Skeletons.Note({ className: `${pfx}__fcol folder`,    content: LOCALE.FOLDER    }),
          Skeletons.Note({ className: `${pfx}__fcol workspace`, content: LOCALE.WORKSPACE }),
          Skeletons.Note({ className: `${pfx}__fcol size`,      content: LOCALE.SIZE      }),
          Skeletons.Note({ className: `${pfx}__fcol versions`,  content: LOCALE.VERSIONS  }),
          Skeletons.Note({ className: `${pfx}__fcol actions`,   content: LOCALE.ACTIONS   }),
        ],
      }),
