...
//   FILE : /src/drumee/modules/desk/wm/notification/widget/notification-list-item/skeleton/private.coffee
//   TYPE : Skeleton
// ==================================================================== *

const __skl_notification_list_entity_item_private = function(_ui_) {
  const entityFig = `${_ui_.fig.family}-entity`;

  const icon = Skeletons.Button.Svg({
    ico       : 'raw-drumee-folder-purple',
    className : `${entityFig}__icon team`
  });//purple"
...
module.exports = __skl_notification_list_entity_item_private;