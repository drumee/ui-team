...
const a = {
  ...
  widget_chat_item:function(s,f){import('builtins/widget/chat-item/index.electron').then(m=>{s(m.default)}).catch(f)},
  ...
  welcome_signin:function(s,f){import('modules/welcome/signin/index.electron').then(m=>{s(m.default)}).catch(f)},
  welcome_signup:function(s,f){import('welcome/signup').then(m=>{s(m.default)}).catch(f)},
  welcome_signin_history:function(s,f){import('modules/welcome/signin/history/index').then(m=>{s(m.default)}).catch(f)},
  butler:function(s,f){import('router/butler/index.electron').then(m=>{s(m.default)}).catch(f)},
