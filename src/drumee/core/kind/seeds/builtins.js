...
module.exports = {
  ...
  notification_list_item:function(s,f){import('desk/notification/widget/notification-list-item').then(m=>{s(m.default)}).catch(f)},
  ...
  notification_window:function(s,f){import('desk/notification/widget/notification-window').then(m=>{s(m.default)}).catch(f)},
