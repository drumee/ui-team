const __preset_template = {
  Xmlns(c) {
    let a;
    return a = `<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#--icon-${c}"></use>`;
  },
  SvgText(text, cn) {
    let a;
