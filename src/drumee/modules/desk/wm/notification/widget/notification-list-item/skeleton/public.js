...
//   FILE : /src/drumee/modules/desk/wm/notification/widget/notification-list-item/skeleton/public.coffee
//   TYPE : Skeleton
// ==================================================================== *

const __skl_notification_list_entity_item_public = function(_ui_) {
  const entityFig = `${_ui_.fig.family}-entity`;

  const icon = Skeletons.Button.Svg({
    ico       : 'raw-drumee-folder-green',
    className : `${entityFig}__icon green`
  });
...
module.exports = __skl_notification_list_entity_item_public;