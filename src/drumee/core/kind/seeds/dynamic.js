...
const a = {
  ...
  DrumeeInteractPlayer:function(s,f){import('builtins/window/interact/player').then(m=>{s(m.default)}).catch(f)},
  ...
  media_local:function(s,f){import('builtins/media/local').then(m=>{s(m.default)}).catch(f)},
  ...
  video_player:function(s,f){import('builtins/player/video/index.electron').then(m=>{s(m.default)}).catch(f)},
  video_viewer:function(s,f){import('builtins/player/video/index.electron').then(m=>{s(m.default)}).catch(f)},
  ...
  widget_chat_item:function(s,f){import('src/drumee/builtins/widget/chat-item/index.electron').then(m=>{s(m.default)}).catch(f)},
  ...
  window_syncer:function(s,f){import('window/syncer').then(m=>{s(m.default)}).catch(f)},
  ...
  outbound_page:function(s,f){import('src/drumee/builtins/window/transferbox/pages/outbound').then(m=>{s(m.default)}).catch(f)},
  inbound_page:function(s,f){import('src/drumee/builtins/window/transferbox/pages/inbound').then(m=>{s(m.default)}).catch(f)},
  window_transferbox:function(s,f){import('src/drumee/builtins/window/transferbox/index').then(m=>{s(m.default)}).catch(f)},
  transferbox_nondrumeete_sendform:function(s,f){import('src/drumee/builtins/window/transferbox/widget/sendtransferbox-nondrumee-form/index').then(m=>{s(m.default)}).catch(f)},
  ...
  form:function(s,f){import('libs/reader/form/current').then(m=>{s(m.default)}).catch(f)},
  iframe:function(s,f){import('libs/reader/iframe').then(m=>{s(m.default)}).catch(f)},
  image_box:function(s,f){import('libs/reader/photo').then(m=>{s(m.default)}).catch(f)},
  image_canvas:function(s,f){import('libs/reader/image/canvas').then(m=>{s(m.default)}).catch(f)},
  image_core:function(s,f){import('libs/reader/image/core').then(m=>{s(m.default)}).catch(f)},
  image_raw:function(s,f){import('libs/reader/image').then(m=>{s(m.default)}).catch(f)},
  image_reader:function(s,f){import('libs/reader/image').then(m=>{s(m.default)}).catch(f)},
  ...
  list_stream:function(s,f){import('libs/reader/list/stream').then(m=>{s(m.default)}).catch(f)},
  media_preview:function(s,f){import('libs/reader/media/preview').then(m=>{s(m.default)}).catch(f)},
  ...
  page:function(s,f){import('libs/reader/page').then(m=>{s(m.default)}).catch(f)},
  path:function(s,f){import('libs/reader/svg/path').then(m=>{s(m.default)}).catch(f)},
  photo:function(s,f){import('libs/reader/photo').then(m=>{s(m.default)}).catch(f)},
  ...
  progress_media:function(s,f){import('libs/reader/progress/media').then(m=>{s(m.default)}).catch(f)},
  ...
  section:function(s,f){import('libs/reader/section').then(m=>{s(m.default)}).catch(f)},
  slidebar:function(s,f){import('libs/reader/slidebar/slidebar').then(m=>{s(m.default)}).catch(f)},
  ...
  video_background:function(s,f){import('libs/reader/video/background').then(m=>{s(m.default)}).catch(f)},
  video_box:function(s,f){import('libs/reader/video/box').then(m=>{s(m.default)}).catch(f)},
  locale_language:function(s,f){import('src/drumee/modules/admin/locale/language').then(m=>{s(m.default)}).catch(f)},
  locale:function(s,f){import('src/drumee/modules/admin/locale/index').then(m=>{s(m.default)}).catch(f)},
  ...
  notification_panel:function(s,f){import('modules/desk/wm/notification/index.electron').then(m=>{s(m.default)}).catch(f)},
  ...
  welcome_offline:function(s,f){import('welcome/offline').then(m=>{s(m.default)}).catch(f)},
  welcome_reset:function(s,f){import('welcome/reset').then(m=>{s(m.default)}).catch(f)},
  welcome_signin:function(s,f){import('src/drumee/modules/welcome/signin/index.electron').then(m=>{s(m.default)}).catch(f)},
  welcome_signup:function(s,f){import('welcome/signup').then(m=>{s(m.default)}).catch(f)},
  welcome_signin_history:function(s,f){import('src/drumee/modules/welcome/signin/history/index').then(m=>{s(m.default)}).catch(f)},
  cop:function(s,f){import('src/drumee/router/cop/index.electron').then(m=>{s(m.default)}).catch(f)},
  debugger:function(s,f){import('router/debugger').then(m=>{s(m.default)}).catch(f)},
  exception_handler:function(s,f){import('router/exception').then(m=>{s(m.default)}).catch(f)},
  ws_channel:function(s,f){import('router/websocket').then(m=>{s(m.default)}).catch(f)},
  screen_thumbnail:function(s,f){import('src/drumee/widgets/electron/screen/thumbnail').then(m=>{s(m.default)}).catch(f)},
  screen_selector:function(s,f){import('src/drumee/widgets/electron/screen').then(m=>{s(m.default)}).catch(f)},
  electron_activity:function(s,f){import('src/drumee/widgets/electron/activity').then(m=>{s(m.default)}).catch(f)},
  electron_update:function(s,f){import('src/drumee/widgets/electron/updater').then(m=>{s(m.default)}).catch(f)},
  ...
  drumee_form_browser:function(s,f){import('store/form/browser').then(m=>{s(m.default)}).catch(f)},
  drumee_form_item:function(s,f){import('store/form/item').then(m=>{s(m.default)}).catch(f)},
  drumee_transfer:function(s,f){import('store/transfer').then(m=>{s(m.default)}).catch(f)},
  drumee_transfer_wm:function(s,f){import('store/transfer/wm').then(m=>{s(m.default)}).catch(f)},
  drumee_transfer_media:function(s,f){import('store/transfer/media').then(m=>{s(m.default)}).catch(f)},
  widget_drumee_transfer_email_item:function(s,f){import('store/transfer/widget/email-item').then(m=>{s(m.default)}).catch(f)},
  widget_drumee_transfer_sender:function(s,f){import('store/transfer/widget/sender').then(m=>{s(m.default)}).catch(f)},
  widget_drumee_transfer_receiver:function(s,f){import('store/transfer/widget/receiver').then(m=>{s(m.default)}).catch(f)},
  drumee_transfer_received_file_item:function(s,f){import('store/transfer/widget/received-file-item').then(m=>{s(m.default)}).catch(f)},
  store_video_thread:function(s,f){import('store/video-thread').then(m=>{s(m.default)}).catch(f)},
  store_video_reader:function(s,f){import('store/video-thread/reader').then(m=>{s(m.default)}).catch(f)},
}
