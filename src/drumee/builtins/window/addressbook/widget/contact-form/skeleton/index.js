  ...
  const name = Skeletons.Box.X({
    ...
    kids: [
      ...
      Skeletons.Box.Y({
        ...
        kids: [
          Skeletons.Box.Y({
            className: `${formFig}__input-wrapper`,
            kids: [
              Skeletons.Note({
                className: `${formFig}__label-input`,
                content: "Firstname",
              }),
              Skeletons.EntryBox({
                ...
                validators: [
                  {
                    reason: LOCALE.FIRST_NAME_REQUIRED,
          ...
          Skeletons.Box.Y({
            ...
            kids: [
              ...
              Skeletons.EntryBox({
                ...
                validators: [
                  {
                    reason: LOCALE.LASTNAME_REQUIRED,
                    comply: Validator.require,
                  },
                ],
              }),
          ...
          Skeletons.Box.Y({
            ...
            kids: [
              Skeletons.Box.X({
                className: `${formFig}__label-wrapper`,
                kids: [
                  Skeletons.Note({
                    className: `${formFig}__label-input`,
                    content: "Custom name",
