...
- `src/drumee/seeds.js` is regenerated by `./webpack/seeds/index.js` (runs as part of `npm run build` / `npm run seeds`). ❌ do not hand-edit — add the widget/window folder + class, then regenerate. Manual edits get overwritten.
