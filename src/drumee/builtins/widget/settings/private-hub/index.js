...
class settings_private_hub extends DrumeeMFS {
  ...
  toggleValidityMode(cmd) {
    ...
    part.feed(require('./skeleton/invitation').default(this, this.validityMode));
  }
  ...
  saveValidity() {
    ...
    if (this.formData.hours != fdata.hours || this.formData.days != fdata.days) {
      ...
      this.saveSettings(_a.expiry, data, (d) => {
        ...
        this.validityMode = _a.view;
        this.getPart('validity-content').feed(require('./skeleton/invitation').default(this, _a.view));
