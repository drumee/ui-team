...
const __skl_restore_buttons = function(view, yes_ext, no_ext, ext, style) {
  ...
  // no_opt      = {contentClass:_C.margin.auto, className:'popup__btn popup__btn--cancel', service: "cancelRestore"}
  if (yes_ext != null) {
  ...
  const buttons = [
    SKL_Note(null, "Log in", yes_opt) //LOCALE.CANCEL
    // SKL_Note(null, "Create new", no_opt) #_L(_I.GOT_IT
  ];
  const row_opt     = {className:"popup__btn-block u-jc-center", kids:buttons, justify:_a.center};
