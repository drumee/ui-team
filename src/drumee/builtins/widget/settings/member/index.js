...
class settings_member extends LetcBox {
  ...
  onUiEvent(cmd, args = {}) {
    ...
    // console.log("cmd:", cmd.model.toJSON());
    ...
    // console.log("================================");
    this.debug("=== settings_member.onUiEvent ===", service);
    switch (service) {
      case "change-permission":
        // Try multiple ways to get privilege and memberId
        let newPrivilege = cmd.get('privilege');
        ...
        if (newPrivilege !== undefined && memberId) {
          ...
          this.debug("Skipping - newPrivilege or memberId missing");
        }
        console.log("=================================");
        break;
    }
