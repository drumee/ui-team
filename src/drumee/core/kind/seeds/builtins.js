...
const a = {
  ...
  countdown_timer:function(s,f){import('builtins/widget/countdown').then(m=>{s(m.default)}).catch(f)},
  invitation_message:function(s,f){import('src/drumee/builtins/widget/invitation/message').then(m=>{s(m.default)}).catch(f)},
  invitation_permission:function(s,f){import('src/drumee/builtins/widget/invitation/permission').then(m=>{s(m.default)}).catch(f)},
  invitation_sharee:function(s,f){import('src/drumee/builtins/widget/invitation/sharee').then(m=>{s(m.default)}).catch(f)},
  invitation_shareeroll:function(s,f){import('src/drumee/builtins/widget/invitation/sharee/roll').then(m=>{s(m.default)}).catch(f)},
  custom_logo:function(s,f){import('src/drumee/builtins/widget/logo').then(m=>{s(m.default)}).catch(f)},
  address_input_item:function(s,f){import('builtins/widget/address-input-item').then(m=>{s(m.default)}).catch(f)},
  contact_invitation_form:function(s,f){import('src/drumee/builtins/widget/contact-invitation-form').then(m=>{s(m.default)}).catch(f)},
  disk_usage:function(s,f){import('src/drumee/builtins/widget/disk-usage').then(m=>{s(m.default)}).catch(f)},
  email_input_item:function(s,f){import('builtins/widget/email-input-item').then(m=>{s(m.default)}).catch(f)},
  phoneno_input_item:function(s,f){import('builtins/widget/phoneno-input-item').then(m=>{s(m.default)}).catch(f)},
  widget_chat:function(s,f){import('src/drumee/builtins/widget/chat').then(m=>{s(m.default)}).catch(f)},
  widget_chat_item:function(s,f){import('src/drumee/builtins/widget/chat-item').then(m=>{s(m.default)}).catch(f)},
  ...
  members_room:function(s,f){import('builtins/window/adminpanel/pages/members/room').then(m=>{s(m.default)}).catch(f)},
  ...
  members_page:function(s,f){import('builtins/window/adminpanel/pages/members').then(m=>{s(m.default)}).catch(f)},
  window_adminpanel:function(s,f){import('builtins/window/adminpanel').then(m=>{s(m.default)}).catch(f)},
  widget_dropdown_menu:function(s,f){import('builtins/window/adminpanel/widget/dropdown-menu').then(m=>{s(m.default)}).catch(f)},
  widget_member_choose_admins:function(s,f){import('builtins/window/adminpanel/widget/member-choose-admins').then(m=>{s(m.default)}).catch(f)},
  widget_member_roles_menu:function(s,f){import('builtins/window/adminpanel/widget/member-roles-menu').then(m=>{s(m.default)}).catch(f)},
  widget_member_roles_menu_items:function(s,f){import('builtins/window/adminpanel/widget/member-roles-menu-items').then(m=>{s(m.default)}).catch(f)},
  widget_member_who_can_see:function(s,f){import('builtins/window/adminpanel/widget/member-who-can-see').then(m=>{s(m.default)}).catch(f)},
  widget_member_detail:function(s,f){import('builtins/window/adminpanel/widget/member_detail').then(m=>{s(m.default)}).catch(f)},
  widget_member_form:function(s,f){import('builtins/window/adminpanel/widget/member_form').then(m=>{s(m.default)}).catch(f)},
  widget_member_tag_item:function(s,f){import('builtins/window/adminpanel/widget/member_tag_item').then(m=>{s(m.default)}).catch(f)},
  widget_member_tags:function(s,f){import('builtins/window/adminpanel/widget/member_tags').then(m=>{s(m.default)}).catch(f)},
  widget_members_list_item:function(s,f){import('builtins/window/adminpanel/widget/members-list-item').then(m=>{s(m.default)}).catch(f)},
  widget_members_search:function(s,f){import('builtins/window/adminpanel/widget/members-search').then(m=>{s(m.default)}).catch(f)},
  widget_members_list:function(s,f){import('builtins/window/adminpanel/widget/members_list').then(m=>{s(m.default)}).catch(f)},
  ...
  widget_helpdesk_category:function(s,f){import('builtins/window/helpdesk/widget/help-category').then(m=>{s(m.default)}).catch(f)},
  widget_helpdesk_item:function(s,f){import('builtins/window/helpdesk/widget/help-item').then(m=>{s(m.default)}).catch(f)},
  widget_simple_invitation:function(s,f){import('builtins/window/schedule/widget/simple-invitation').then(m=>{s(m.default)}).catch(f)},
  ...
  widget_sharebox_members_list_item:function(s,f){import('builtins/window/sharebox/widget/invitation-email-item').then(m=>{s(m.default)}).catch(f)},
  ...
  locale:function(s,f){import('modules/devel/locale').then(m=>{s(m.default)}).catch(f)},
  dmz_window_manager:function(s,f){import('src/drumee/modules/dmz/wm').then(m=>{s(m.default)}).catch(f)},
  dmz_sharebox:function(s,f){import('src/drumee/modules/dmz/sharebox').then(m=>{s(m.default)}).catch(f)},
  dmz_meeting:function(s,f){import('src/drumee/modules/dmz/meeting').then(m=>{s(m.default)}).catch(f)},
  ...
  welcome_invitation:function(s,f){import('src/drumee/modules/welcome/invitation').then(m=>{s(m.default)}).catch(f)},
  welcome_feedback:function(s,f){import('src/drumee/modules/welcome/feedback').then(m=>{s(m.default)}).catch(f)},
  welcome_reset:function(s,f){import('src/drumee/modules/welcome/reset').then(m=>{s(m.default)}).catch(f)},
  welcome_signin:function(s,f){import('src/drumee/modules/welcome/signin').then(m=>{s(m.default)}).catch(f)},
  welcome_signup:function(s,f){import('src/drumee/modules/welcome/signup').then(m=>{s(m.default)}).catch(f)},
  butler:function(s,f){import('src/drumee/router/butler').then(m=>{s(m.default)}).catch(f)},
  ws_channel:function(s,f){import('src/drumee/router/websocket').then(m=>{s(m.default)}).catch(f)},
  module_desk:function(s,f){import('src/drumee/modules/desk').then(m=>{s(m.default)}).catch(f)},
  module_devel:function(s,f){import('src/drumee/modules/devel').then(m=>{s(m.default)}).catch(f)},
  module_dmz:function(s,f){import('src/drumee/modules/dmz').then(m=>{s(m.default)}).catch(f)},
  ...
  module_welcome:function(s,f){import('src/drumee/modules/welcome').then(m=>{s(m.default)}).catch(f)},
}
